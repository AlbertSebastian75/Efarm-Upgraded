...
echo "<a href=wishlist.php?items_id=".$items_id. "><center><button class=a6>ADD WISHLIST</button></center></a>
<a href=buy_directly.php?items_id=".$items_id. "><center><button class=a6>BUY</button></center></a>";
