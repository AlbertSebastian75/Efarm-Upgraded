...
<html>
<head>
 <title><?php echo $_SESSION['usr']; ?> | Items</title>
</head>
<body>
    <style>
		body{
...
if (mysqli_connect_error()) {
       ...
       if($resultCheck > 0){
           while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td>₹".$row['price']."<br><a href=decr_prize.php?items_id=".$row['items_id']. "><button>-</button></a>
            <a href=incr_prize.php?items_id=".$row['items_id']. "><button>+</button></a></td>";
            echo "<td><a href=decr_item.php?items_id=".$row['items_id']. "><button>-</button></a>".$row['stock'].
            "<a href=incr_item.php?items_id=".$row['items_id']. "><button>+</button></a></td>";
            echo "<td>".$row['rol'] ."</td>";
            $pathx = "image/";
            $file = $row["img"];
            echo "<td>";
            ...
            echo "</td>";
            echo "<td>
                  <a href=admin_vendor_prod_request.php?items_id=$row[items_id]><button>ADD to Vendors</button></a>
