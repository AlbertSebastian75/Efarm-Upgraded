...
<html>
<head>
 <title><?php echo $_SESSION['usr']; ?> | Re-Order Level</title>
</head>
<body>
    <style>
		body{
...
if (mysqli_connect_error()) {
        ...
        $sql = "SELECT * from items where stock<=rol;";
       ...
       if($resultCheck > 0){
           while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "</td>";
            echo "<td><a href=vendor/view_vendor_product.php?items_id=".$row['items_id']. "><button>VIEW REQUEST</button></a></td>";
