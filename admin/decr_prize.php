...
<input type="submit" class="a33" name="submit">
</form>
<!--Search End-->
...
<center>
    <form action="decr_prize_conn.php" method="post">
    <input type="hidden" name=items_id value=<?php echo $items_id; ?>>
    <input type="hidden" name=price value=<?php echo $price; ?>>
    <br><br>
    Amount: ₹<input type="number" min="1" class="a6" name="price_incr" autofocus><br>
    <input type="submit" class="a66" value="-">
</form></center>
