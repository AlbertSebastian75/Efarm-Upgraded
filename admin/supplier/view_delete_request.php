...
<div class="topnav">
    ...
    <h4>VIEW DELETE SUPPPLIER REQUESTS</h4>
...
if (mysqli_connect_error()) {
        ...
        $sql = "SELECT * from supplier where `status`=3;";
       ...
       if($resultCheck > 0){
          ...
          echo "<tr>";
            ...
            echo ", ".$row['district'];
            echo ", ".$row['city'] ."</td>";
            echo "<td><a href=delete_supplier.php?supplier_id=".$row['supplier_id']. "><button>DELETE</button></a></td>";
            echo "</tr>";
