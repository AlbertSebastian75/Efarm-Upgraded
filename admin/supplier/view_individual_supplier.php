...
if (mysqli_connect_error()) {
    ...
    echo "<h4>VIEW SUPPLIERS</h4>
        ...
        $sql1 = "SELECT * from sales where supplier=$txt6 and `status`='4'";
        $result1=mysqli_query($conn, $sql1);
        $resultCheck1 = mysqli_num_rows($result1);
        echo "</table><table align=center border=1 bgcolor=LightGoldenRodYellow><h4>PENDING DELIVERY CONFORMATION</h4>";
        ...
        echo "<td>No. of Pending <br>Conformation: ".$c."</td><td>Total Prize: ₹".$t."</td>";
    }
            

           $sql1 = "SELECT * from sales where supplier=$txt6 and `status`='3'";
           $result1=mysqli_query($conn, $sql1);
           $resultCheck1 = mysqli_num_rows($result1);
           echo "</table><table align=center border=1 bgcolor=LightGoldenRodYellow><h4>PROCESSING ORDERS</h4>";
           ...
           while ($row1 = mysqli_fetch_assoc($result1)) {
            $c+=1;
              ...
              // echo "<td>".$row1['items_id'] ."</td>";
               ...
               $t=$t+$row1['total'];
               echo "<td>".$row1['date'] ."</td>";	
               echo "<td>".$row1['proc_date'] ."</td>";	
             //  echo "<td><a href=../user_individual.php?users_id=".$row1['users_id']. ">USER DETAILS</a></td>";
             //  echo "<td><a href=../item_individual.php?items_id=".$row1['items_id']. ">ITEM DETAILS</a></td>";
               echo "</tr>";
           }	
           echo "<td>No. of Order <br>Processing: ".$c."</td><td>Total Prize: ₹".$t."</td>";
       }

       

       $sql1 = "SELECT * from sales where supplier=$txt6 and `status`='2'";
       $result1=mysqli_query($conn, $sql1);
       $resultCheck1 = mysqli_num_rows($result1);
       echo "</table><table align=center border=1 bgcolor=LightGoldenRodYellow><h4>ASSIGNED ORDERS</h4>";
       ...
       while ($row1 = mysqli_fetch_assoc($result1)) {
        $c+=1;
         ...
         //  echo "<td>".$row1['items_id'] ."</td>";
           ...
           $t=$t+$row1['total'];
           echo "<td>".$row1['date'] ."</td>";	
           echo "<td>".$row1['supplier_date'] ."</td>";		
         //  echo "<td><a href=../user_individual.php?users_id=".$row1['users_id']. ">USER DETAILS</a></td>";
         //  echo "<td><a href=../item_individual.php?items_id=".$row1['items_id']. ">ITEM DETAILS</a></td>";
           echo "</tr>";
       }
       echo "<td>No. of Order <br>Assigned: ".$c."</td><td>Total Prize: ₹".$t."</td>";
   }

   
   $sql1 = "SELECT * from sales where supplier=$txt6 and `status`='1'";
   $result1=mysqli_query($conn, $sql1);
   $resultCheck1 = mysqli_num_rows($result1);
   echo "</table><table align=center border=1 bgcolor=LightGoldenRodYellow><h4>REQUESTED ORDERS</h4>";
   ...
   while ($row1 = mysqli_fetch_assoc($result1)) {
    $c+=1;
       echo "<tr>";
       echo "<td>".$sales_id=$row1['sales_id'] ."</td>";
       echo "<td><a href=../user_individual.php?users_id=".$row1['users_id']. ">".$row1['users_id']."</a></td>";
       echo "<td><a href=../item_individual.php?items_id=".$row1['items_id']. ">".$row1['items_id']."</a></td>";
     //  echo "<td>".$row1['users_id'] ."</td>";
     //  echo "<td>".$row1['items_id'] ."</td>";
...
<input type="hidden" class="b2" name="sales_id" autofocus value=<?php echo $sales_id; ?>
<input type="hidden" class="b2" name="supplier_idd" autofocus value=<?php echo $supplier_idd; ?>
...
<?php
   ...
   echo "<td>No. of Order <br>Requested: ".$c."</td><td>Total Prize: ₹".$t."</td>";
}
