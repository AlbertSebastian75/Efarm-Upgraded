...
if (isset($_POST["submit"])) {
	$str = $_POST["search"];
	$sth = $con->prepare("SELECT * FROM `supplier` WHERE name like '%$str%'");
	...
	if($row = $sth->fetch())
	{
		...
		<tr><th>Vendor ID</th><td><?php echo $row->supplier_id;$ww=$row->supplier_id;?></td></tr>
		<tr><th>Name</th><td><?php echo $row->name; ?></td></tr>
		<tr><th>Email</th><td><?php echo $row->email;?></td></tr>
		<tr><th>Address</th><td><?php echo $row->aadhar;?></td></tr>
		<tr><th>Address</th><td><?php echo $row->address;?></td></tr>
		<tr><th>Mobile</th><td><?php echo $row->mobile;?></td></tr>
		<tr><th>Mobile</th><td><?php echo $row->location;?></td></tr>
		<tr><th>Mobile</th><td><?php echo $row->city,  $row->district, $row->state, $row->country?></td></tr>
