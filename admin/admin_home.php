...
if (mysqli_connect_error()) {
       ...
       if($resultCheck > 0){
        $t=0;$c=0;$delivery_total=0;$delivery_count=0;
           while ($row = mysqli_fetch_assoc($result)) {
            ...
            if($status ==5){ 
            ...
            else if($uuu==$row['users_id']){
              echo "<td>User Not Exist</td>";
            }
            else if($status==2){ 
              echo "<td>Assigned</td>";
            }
              ...
              echo "<td>Pending Conformation</td>";
            }
            else if($status==1){ 
              //echo "<td><a href=../pdf/admin-pdf-generation.php?sales_id=$row[sales_id]><img src=../pdf/pdf-image.png height=35 width=25></a></td>";
            ...
            if($status==5){ 
              echo "<td><a href=../pdf/user-pdf-generation.php?sales_id=$row[sales_id]><img src=../pdf/pdf-image.png height=35 width=25></a></td>";
            }
            else if($uuu==$row['users_id']){
              echo "<td><button>Not Available</button></td>";
            }
            else{
       ...
       echo "</table><table border=5><tr><td>Total no. of Orders: <th>".$c."</th></tr>
       <tr></td><td>Total Prize: <th>₹".$t."</th></tr>";
?>
</table>
</body>
</html>