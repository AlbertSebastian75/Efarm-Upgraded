...
$txt8=filter_input(INPUT_POST, 'rol');
if (!empty($txt1)){
if (!empty($txt2)){
if (!empty($txt3)){
if (!empty($txt4)){
...
if (mysqli_connect_error()) {
    ...
    $sql="UPDATE items SET `name`='$txt1', brand='$txt2', `description`='$txt3', types='$txt4', price='$txt5', stock='$txt6', rol='$txt8' where items_id='$txt7'";
