...
<br>
  <form method="post" action="insert_item_connection.php" enctype="multipart/form-data">
    <center>  <table>
                ...
                <td></tr><tr><th>Re-Order Level:</th><td>
                <input type="number" class="b2" name="rol" min="0" required><td></tr>
                <tr><td></td><td><input type="file" name="uploadfile" required/></td></tr>
