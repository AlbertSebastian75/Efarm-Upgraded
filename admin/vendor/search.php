...
if (isset($_POST["submit"])) {
	$str = $_POST["search"];
	$sth = $con->prepare("SELECT * FROM `vendor` WHERE fullname like '%$str%'");
	...
	if($row = $sth->fetch())
	{
		...
		<tr><th>Vendor ID</th><td><?php echo $row->vendorid;$ww=$row->vendorid;?></td></tr>
		<tr><th>Name</th><td><?php echo $row->fullname; ?></td></tr>
		<tr><th>Company Name</th><td><?php echo $row->companyname; ?></td></tr>
