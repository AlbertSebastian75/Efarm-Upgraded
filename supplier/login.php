...
<html>
<head>
	<title>Supplier Login| Efarm</title>
</head>
<body>
<style>
		body{
	...
	<form action="login_connection.php" method="POST" enctype="multipart/form-data">
		...
		<td><input type="password" name="password" minlength="6" required placeholder="Password"><td></tr>
	</table>
	...
	<?php
		...
		<a class="a1" href="insert_supplier.php">Register</a>
