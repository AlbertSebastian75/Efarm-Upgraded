...
<html>
<head>
	<title>Orders | <?php echo $_SESSION['name'] ?></title>
    <style>
		body{
    ...
    echo "<table align=center border=1 bgcolor=LightGoldenRodYellow><tr>
       ...
       if($resultCheck > 0){
           while ($row = mysqli_fetch_assoc($result)) {
            ...
            $sql1 = "SELECT * from sales where users_id=$u and supplier=$supplier_id and `status`='2'";
            ...
            while ($row1 = mysqli_fetch_assoc($result1)) {
                ...
                echo "<td><a href=sales_processing.php?sales_id=".$row1['sales_id']. "><button>REACHED</button></a></td>";
                echo "</tr>";
