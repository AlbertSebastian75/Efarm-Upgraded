...
<html>
<head>
	<title>Processing | <?php echo $_SESSION['name'] ?></title>
    <style>
		body{
...
if (mysqli_connect_error()) {
    ...
    echo "<table align=center border=1 bgcolor=LightGoldenRodYellow><tr>
        ...
        <th>Quantity</th>
        <th>Total</th>
        <th>Customer order <br>Date</th>
        <th>Supplier Processing <br>Date</th>
        <th>User Details</th>
        <th>Item Details</th>
        <th>Action</th>
    </tr>";
       ...
       if($resultCheck > 0){
           while ($row = mysqli_fetch_assoc($result)) {
            ...
            $sql1 = "SELECT * from sales where users_id=$u and supplier=$supplier_id and `status`='3'";
            ...
            while ($row1 = mysqli_fetch_assoc($result1)) {
                ...
                echo "<td><a href=deliver_request.php?sales_id=".$row1['sales_id']. "><button>deliver request</button></a></td>";
                echo "</tr>";
