...
<html>
<head>
	<title>Pending Orders | <?php echo $_SESSION['name'] ?></title>
    <style>
		body{
...
if (mysqli_connect_error()) {
    ...
    echo "<table align=center border=1 bgcolor=LightGoldenRodYellow><tr>
        ...
        <th>Supplier Processing Date</th>
        <th>User Details</th>
        <th>Item Details</th>
    </tr>";
       ...
       if($resultCheck > 0){
           while ($row = mysqli_fetch_assoc($result)) {
            ...
            $sql1 = "SELECT * from sales where users_id=$u and supplier=$supplier_id and `status`='4'";
