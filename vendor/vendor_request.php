...
<html>
<head>
 <title><?php echo $_SESSION['fullname']; ?> | Apply</title>
...
<table align="center">
    <form action="vendor_request_conn.php" method="post">
        
      <input type="hidden" name="vendorid" value="<?php echo $vendorid; ?>" >
        <tr><th>Item ID: </th><td><input type="text" name="items_id" value="<?php echo $items_id; ?>" readonly></td></tr>
        <tr><th> Prize: </th><td><input type="number" name="prize" min="1" required><br></td></tr>
        <tr><th> Quantity:</th><td> <input type="number" name="qty" min="1" required></td></tr>
